...
namespace SamplerGAN.MetadataService.WebApi.Controllers {
  ...
  public class MetadataController : ControllerBase {
    ...
    //http://localhost:5099/api/healthchecks [GET]
    [Route ("healthchecks")]
    [HttpGet]
    ...
    //http://localhost:5099/api/users/{id}/files/ [GET]
    ...
    //http://localhost:5099/api/users/{id}/folders/ [GET]
    ...
    //http://localhost:5099/api/user/{id}/file/{id} [GET]
    ...
    //http://localhost:5099/api/users/{id}/folders/{id} [GET]
    ...
    //http://localhost:5099/api/users/{id}/files [POST]
    ...
    //http://localhost:5099/api/users/{id}/folders [POST]
    ...
    */
    ...
    //http://localhost:5099/api/files/{id} [PATCH]
    ...
    //http://localhost:5099/api/folders/{id} [PATCH]
    ...
    //http://localhost:5099/api/files/{id} [DELETE]
    ...
    //http://localhost:5099/api/folders/{id} [DELETE]
